...
const char* ei_classifier_inferencing_categories[] = { "bottle", "can" };
...
const ei_impulse_t impulse_566766_0 = {
    .project_id = 566766,
    .project_owner = "Hải Lưu",
    .project_name = "hailuu1905-project-1",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_566766_0 = ei_impulse_handle_t( &impulse_566766_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_566766_0;
